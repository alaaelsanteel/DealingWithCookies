...
namespace DealingWithOPML.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostToggl(bool isFavorite, string pubDate, string url, string title, string description)
        {
            ...
            if (favoriteFeeds.ContainsKey(pubDate))
            {
                var report = favoriteFeeds[pubDate];
                report.IsFavorite = !report.IsFavorite;

                favoriteFeeds[pubDate] = report;
            }
            else
            {
                var report = new RssItem
                {
                    Title = title,
                ...
                favoriteFeeds[report.PubDate] = report;
            }
